 ...
 */
 ...
 if (process.argv.length < 5){console.log(`Al Hind DDos made by GreyHat > Usage: node ddos.js URL TIME REQ_PER_SEC THREADS\nExample: node ddos.js https://xyz.com 500 8 6`); process.exit();}
